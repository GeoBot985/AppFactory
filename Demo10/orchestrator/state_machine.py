...
class StateMachine:
    def __init__(self):
        self.transitions: Dict[OrchestratorStage, Set[OrchestratorStage]] = {
            ...
            OrchestratorStage.COMPILE: {OrchestratorStage.PLAN_MATERIALIZATION, OrchestratorStage.COMPILE_REPAIR, OrchestratorStage.FAILED},
            OrchestratorStage.COMPILE_REPAIR: {OrchestratorStage.COMPILE, OrchestratorStage.FAILED},
            OrchestratorStage.PLAN_MATERIALIZATION: {OrchestratorStage.PREVIEW_SIMULATION, OrchestratorStage.FAILED},
    ...
    def get_next_normal_stage(self, current_stage: OrchestratorStage) -> Optional[OrchestratorStage]:
        pipeline = [
            ...
            OrchestratorStage.PLAN_MATERIALIZATION,
